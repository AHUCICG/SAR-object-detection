...
class MBConvBlock(nn.Module):
    ...
    '''
    def __init__(self, kernel_size, in_chans, out_channels, expand_ratio=1, stride=1, image_size=224):
        super().__init__()
        self._bn_mom = 0.1
        self._bn_eps = 0.01
        self._se_ratio = 0.25
        self._input_filters = in_chans
        self._output_filters = out_channels
