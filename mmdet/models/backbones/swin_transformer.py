...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, patch_size=4, hidden_features=None, out_features=None,act_layer=nn.GELU, drop=0.):
        super().__init__()
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        ...
        if norm_layer is not None:
            ...
            self.norm = None
        self.mbconv = MBConvBlock(kernel_size=4, in_chans=3, out_channels=3)

        self.cot = CoTAttention(dim=96, kernel_size=3)
